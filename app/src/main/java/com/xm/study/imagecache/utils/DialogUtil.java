package com.xm.study.imagecache.utils;
...
public class DialogUtil {
	...
	public static void showAnyDialog(Context context,int resource,Bitmap bm,final ItemOnListener listener){
       ...
       /* int sdkApi=Integer.parseInt(android.os.Build.VERSION.SDK);
        ...
        Button closeButton = (Button) mFloatLayout.findViewById(ResUtil.id(context, "image_cache_dialog_btn_close"));
		 ImageView imageView = (ImageView) mFloatLayout.findViewById(ResUtil.id(context, "image_cache_dialog_iv_show"));
	...
	public static void showDialog(Context context,Bitmap bm,ItemOnListener listener){
		showDialog(context.getApplicationContext(), ResUtil.layout(context, "image_cache_dialog"), ResUtil.style(context, "bs_transparent_dialog"),bm, listener);
	}
	...
	public static void showDialog(Context context,int resource,int style,Bitmap bm,final ItemOnListener listener){
		 ...
		 if (sdkApi>=19) {
			 ...
			 dialog.getWindow().setType(LayoutParams.TYPE_PHONE);
		}
		 dialog.show();

		 LayoutParams params = dialog.getWindow().getAttributes();// 得到属性
		 ...
		 Button closeButton = (Button) view.findViewById(ResUtil.id(context, "image_cache_dialog_btn_close"));
		 ImageView imageView = (ImageView) view.findViewById(ResUtil.id(context, "image_cache_dialog_iv_show"));
		 imageView.setImageBitmap(bm);
