package com.xm.study.easechat.chat;
...
import com.xm.study.easechat.chat.presenter.ECChatPresenterCompl;
import com.xm.study.easechat.chat.presenter.IECChatPresenter;
import com.xm.study.easechat.chat.view.IECChatView;

import java.util.List;

public class ECChatActivity extends BaseActivity implements IECChatView, EMMessageListener {

    private final String TAG = this.getClass().getSimpleName();
    private IECChatPresenter mIECChatPresenter;

    // 聊天信息输入框
    private EditText mEditMessageInput;
    // 发送按钮
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIECChatPresenter = new ECChatPresenterCompl(this, this);
    ...
    private void initView() {
        mEditMessageInput = (EditText) findViewById(R.id.et_message_input);
        ...
        mBtnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String content = mEditMessageInput.getText().toString().trim();
                if (!TextUtils.isEmpty(content)) {
                    mEditMessageInput.setText("");
    ...
    private void initConversation() {
        ...
        if (mConversation.getAllMessages().size() > 0) {
            ...
            // 将消息内容和时间显示出来
            mTvContent.setText("聊天记录：" + body.getMessage() + " - time: " + mConversation.getLastMessage().getMsgTime());
        }
    }
